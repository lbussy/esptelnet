 ...
 * "ESPTelnet" instead of "Serial" to send data to the serial port and a copy
 ...
 * possible to use more than one instance of ESPTelnet, for example to send
 ...
 *		LOG.handle();
 *
 * Use the following functions of the ESPTelnet object to modify behavior
 *
 ...
 * Default: "ESPTelnet: Only one connection possible.\n"
 ...
 *
 * If no data is sent via ESPTelnet the detection of a disconnected client has
 ...
 *	- execute "ESPTelnet.begin(WhatEverYouWant);"
 *
 * The order is not important.
 *
 * All you do with "Serial" you can also do with "ESPTelnet", but remember:
 ...
 * time. But its possible to use more than one instance of ESPTelnet.
 *
 * If you have problems with low memory you may reduce the value of the define
 * ESPTELNET_BUFFER_LEN for a smaller ring buffer on initialisation.    
 *
 * Usage of void setDebugOutput(bool) to enable / disable of capturing of
 * os_print calls when you have more than one ESPTelnet instance: That
 * ESPTelnet object will handle this functionallity where you used
 * setDebugOutput at last. On default ESPTelnet has the capturing of OS_print
...
#define ESPTELNET_REJECT_MSG "ESPTelnet: Only one connection possible.\r\n"
